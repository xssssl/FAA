...
from .parseconfig import Parsearrival
import os
from scrapy import signals

class ArrivalSpider(scrapy.Spider):
    name = "arrival"

    def __init__(self):
        super(ArrivalSpider, self).__init__()
        self.url = 'https://www.transtats.bts.gov/ONTIME/Arrivals.aspx'
        ...
        self.config = Parsearrival().readall()
        self.start_flag = 0

    # close the browser when the spider is closed
    @classmethod
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(ArrivalSpider, cls).from_crawler(crawler, *args, **kwargs)
